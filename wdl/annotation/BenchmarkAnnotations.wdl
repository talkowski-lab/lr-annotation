...
workflow BenchmarkAnnotations {
    input {
        ...
        String sv_type_eval_field = "allele_type"
        String sv_length_eval_field = "allele_length"
    ...
    scatter (idx in range(length(contigs))) {
        ...
        call TruvariMatch.TruvariMatch {
            input:
                ...
                sv_length_eval_field = sv_length_eval_field,
                ref_fa = ref_fa,
                ref_fai = ref_fai,
        ...
        call BedtoolsClosestSV.BedtoolsClosestSV {
            input:
                ...
                sv_type_eval_field = sv_type_eval_field,
                sv_length_eval_field = sv_length_eval_field,
